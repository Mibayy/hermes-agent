...
class TestSingleQueryState:
    ...
    def test_queue_mode_defaults_to_off(self):
        cli = _make_cli()
        assert cli._queue_mode is False

    def test_queue_mode_toggle(self):
        cli = _make_cli()
        cli._queue_mode = True
        assert cli._queue_mode is True
        cli._queue_mode = False
        assert cli._queue_mode is False
