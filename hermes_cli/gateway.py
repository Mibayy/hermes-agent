...
_PLATFORMS = [
    ...
    },
    {
        ...
        "token_var": "XMPP_JID",
        "setup_instructions": [
            "1. You need an XMPP account (JID) and password.",
            "2. Create an account at any XMPP server (e.g., jabber.org, conversations.im)",
            "3. Or self-host using Prosody, ejabberd, or Openfire.",
            "4. Install slixmpp: pip install slixmpp",
            "5. Optionally install slixmpp-omemo for E2EE: pip install slixmpp-omemo",
        ],
        "vars": [
            {"name": "XMPP_JID", "prompt": "XMPP JID (e.g., hermes@example.org)", "password": False,
             "help": "The full Jabber ID your bot will use."},
            {"name": "XMPP_PASSWORD", "prompt": "XMPP password", "password": True,
             "help": "Password for the XMPP account."},
            {"name": "XMPP_HOME_CHANNEL", "prompt": "Home JID (for notifications, or empty)", "password": False,
             "help": "JID to message on startup and for cron delivery."},
            {"name": "XMPP_ALLOWED_USERS", "prompt": "Allowed JIDs (comma-separated, or empty for all)", "password": False,
             "is_allowlist": True,
             "help": "Only messages from these JIDs will be processed."},
        ],
    },
    {
        "key": "dingtalk",
