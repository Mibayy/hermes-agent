...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            "1. Go to https://open.feishu.cn/app → Create a Custom App",
            "2. Under 'Credentials & Basic Info', copy the App ID and App Secret",
            "3. Under 'Add Features', enable 'Bot'",
            "4. Under 'Permissions & Scopes', add im:message and im:message.receive_v1",
            "5. Enable Event Subscriptions and add im.message.receive_v1",
            "6. Use Long Connection mode (no public server needed)",
        ],
        "vars": [
            {"name": "FEISHU_APP_ID", "prompt": "App ID (cli_xxxx)", "password": False,
             "help": "The App ID from your Feishu application credentials."},
            {"name": "FEISHU_APP_SECRET", "prompt": "App Secret", "password": True,
             "help": "The App Secret from your Feishu application credentials."},
            {"name": "FEISHU_ALLOWED_USERS", "prompt": "Allowed Open IDs (comma-separated, or empty for pairing mode)", "password": False,
             "is_allowlist": True,
             "help": "Only messages from these Feishu Open IDs will be processed."},
            {"name": "FEISHU_HOME_CHANNEL", "prompt": "Home channel ID (chat_id for cron delivery, or empty)", "password": False,
             "help": "Chat ID to deliver cron job results and notifications to."},
        ],
    },
    {
        "key": "dingtalk",
